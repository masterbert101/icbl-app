...
<div class="max-w-screen-lg mx-auto p-5 pb-20">
  ...
  >
    <div class="bg-[#0a0e30] md:col-span-4 p-10 text-white">
      ...
      <div class="grid grid-cols-[max-content_1fr] items-center mt-5 gap-3">
        ...
        >
          ...
          <path
            ...
            stroke-width="1.5"
          />
          <circle cx="12" cy="8" r="2" stroke="#fff" stroke-width="1.5" />
        </svg>
        <span class="text-sm"
          >UG 7 Cityland 8 Condominium No. 98 Sen Gil Puyat Avenue Makati City</span
        >
      </div>
      <div class="grid grid-cols-[max-content_1fr] items-center mt-5 gap-3">
        <svg
        ...
        >
          ...
          />
          <circle cx="12" cy="19" r="1" stroke="#fff" />
          <path d="M4 17H20" stroke="#fff" />
          <path d="M4 7H20" stroke="#fff" />
        </svg>
        <span class="text-sm">0917-899-9031</span>
      </div>
      ...
      <div class="grid grid-cols-[max-content_1fr] items-center mt-5 gap-3">
        ...
        <span class="text-sm">(02) 8812 – 5965</span>
      </div>
      ...
      <div class="grid grid-cols-[max-content_1fr] items-center mt-5 gap-3">
        ...
        <span class="text-sm">cs@icbestlink.com</span>
      </div>
    </div>
    {#if thankyou}
      <div class="md:col-span-8 p-10 text-center min-h-[655px]">
        <h2 class="text-5xl font-bold mb-4 text-[#0a0e30]">Thank You!</h2>
        <p class="text-gray-700">
          {firstName} Your message has been sent successfully. <br /> We will contact
          you shortly
        </p>
      </div>
    {:else}
      <form class="md:col-span-8 p-10 min-h-[655px]" onsubmit={handleSubmit}>
