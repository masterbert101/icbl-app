	...
	let productCategories = [
		...
		},
		{
			...
			products: [
				...
				{ src: '/Data Rack Open Type Wall Mount.jpg', alt: 'Data Rack Open Type Wall Mount' },
				{ src: '/Open Bay Rack.jpg', alt: 'Open Bay Rack' },
				{ src: '/Pull Box.jpg', alt: 'Pull Box' },
				{ src: '/Rack Mounting Components.jpg', alt: 'Rack Mounting Components' },
		...
		},
		{
			...
			products: [
				...
				{ src: '/APC.png', alt: 'APC' },
				{ src: '/Business Partner Enterprise.png', alt: 'Business Partner Enterprise' },
...
<section class="">
	<div class="text-center mb-12">
		...
		<p class="text-xl text-gray-600 max-w-2xl mx-auto">
			Discover the best tech products from top brands across different categories
		</p>
	</div>
	...
	<div class="grid gap-8 md:gap-12">
		{#each productCategories as category}
			<div
				class="hover:shadow-[0px_3px_17px_-2px_rgba(0,_0,_0,_0.5)] rounded-2xl p-8 shadow-xl transition-shadow duration-300 max-w-7xl mx-auto"
			>
				<div class="flex items-center mb-6">
					...
					<div>
						...
						<p class="text-gray-600">Lorem Ipsum excerpt</p>
					</div>
				</div>
				...
				<div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
					{#each category.products as product}
						<div
							class="flex items-center brand-card bg-gray-50 hover:shadow-[0px_3px_17px_-2px_rgba(0,_0,_0,_0.25)] rounded-lg p-4 transition-all duration-200 group"
						>
							<img
