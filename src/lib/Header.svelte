...
<div class="header" class:addBG={scrollY >= 500}>
	<nav class="desktop-nav">
		<ul class="primary">
			<li class="mr-10">
				<a class="brand" href="/" aria-label="ICBL">
					<img class="object-cover" src="/logo.png" alt="Logo" width="175" height="auto" />
				</a>
			</li>
	...
	<div class="mobile-nav">
		<a class="" href="/" aria-label="ICBL">
			<img class="object-cover" src="/logo.png" alt="Logo" width="200" height="auto" />
		</a>
